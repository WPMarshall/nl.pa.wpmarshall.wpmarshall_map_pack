{
    "name": "Diskus (Teams)",	"creator": "WPMarshall", 	"version": "1", "date": "2016/04/28",	"description": "A crazy planet inspired by Geothermal Borehole, teams must manage each of the lanes, contesting and controlling the central disk to capture expansions",
