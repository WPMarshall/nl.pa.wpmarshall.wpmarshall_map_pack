{
    ...
    "description": "(5v5) Shared or Non-shared, Station Sigma challenges teams to evenly distribute their forces and economy in order to contest all channels between poles. Lose one and you run the risk of defeat!",
    "creator": "WPMarshall",
    "version": "1.5.0",
    "planets": [
        {
