{
	...
	"creator": "WPMarshall",
	"version": "1.1.1",
    "description": "Landmass, Lanes, Chokepoints, Naval Element",
	"date": "2016/07/02",
	"description": "(1v1 - 2v2) Naval Element | This medium sized ice-planet, also suitable for team games (particularly 2v2), provides multiple routes to attack your opponent as well as some key central expansion sites that will encourage raiding and combat.",	"players": [
        2,
        4    ],	
    "planets": [
        {
